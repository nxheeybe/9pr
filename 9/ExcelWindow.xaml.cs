...
namespace _9
{
    public partial class ExcelWindow : Window
    {
        ...
        private void ClearGrid()
        {
            ...
            {
                MessageBox.Show("и так ничего нет!");
            }
        }
        ...
        private void ClearTable()
        {
            ...
            {
                MessageBox.Show("таблицы и так нееет!");
            }
        }
